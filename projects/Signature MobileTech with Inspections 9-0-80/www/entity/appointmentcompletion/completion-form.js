...
//============== LIST COLLECTIONS ================
// --- TASK ---
taskGroupBy = "gpequipmentid_gptasklistid";
taskGroupHeader = function (data) {
    return $("<h3>").append(
        $("<br>"),
        $("<span>").append(data.items[0].gptasklistid ? "Task List: " + data.items[0].gptasklistid : "Tasks: "),
...
taskSubGroupTemplate = function (data, _, element) {
    return element.append(
        ...
        $("<i>").append(data.items[0].gptaskcode + ": " + (data.items[0].description ? data.items[0].description : "")),
